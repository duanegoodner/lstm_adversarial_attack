...
class AttackAnalysesBuilder:
    ...
    def __init__(
        ...
        """
        :param trainer_result_path: pickle file containing TrainerResult from
        attack on dataset and model
        :param seq_length: input sequence length of adversarial attack
        examples to analyze
        :param min_num_perts: min number of nonzero perturbation elements in
        perturbation arrays of samples to analyze
        :param max_num_perts: max number of nonzero perturbation elements in
        perturbation arrays of samples to analyze
        """
    ...
    def attack_results(self) -> ata.FullAttackResults:
        """
        FullAttackResults computed from self.success_summary
    ...
    def df_tuple_for_histogram_plotter(
        ...
        """
        Convenience getter. Calls the .data_for_histograms_plotter method
        of self.standard_attack_analyses
    ...
    def plot_susceptibility_metric(
        ...
        """
        Generates heatmap plots of an AttackSusceptibilityMetrics attribute
        :param metric: name of attribute to plot
...
def plot_latest_result():
    """
    Generates perturbation histograms and susceptibility metric heatmaps of
    data most recently generated by running attack with fixed set of
    parameters. Uses data from newest directory in
    data/attack/frozen_hyperparameter_attack
    """
