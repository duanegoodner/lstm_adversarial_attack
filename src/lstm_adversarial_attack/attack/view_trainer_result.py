...
from attack_result_data_structs import AttackSummary, AttackSummary2, TrainerSuccessSummary
from lstm_adversarial_attack.config_paths import ATTACK_OUTPUT_DIR

trainer_result = (
    rio.ResourceImporter()
    .import_pickle_to_object(
...
# attack_summary_2 = AttackSummary2.from_trainer_result(
#     trainer_result=trainer_result
# )
